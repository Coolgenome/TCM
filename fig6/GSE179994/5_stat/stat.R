...
CD8_meta <- read_tsv("/rsrch3/scratch/genomic_med/ychu2/projects/p1review/R3Q7/result/GSE179994/MappingResult/CD8/meta_2022-03-09.tsv")
CD8_meta$isResponse <- "No"
CD8_meta$isResponse[CD8_meta$sample %in% ResponseSamples] <- "Yes"

CD4_meta <- read_tsv("/rsrch3/scratch/genomic_med/ychu2/projects/p1review/R3Q7/result/GSE179994/MappingResult/CD4/meta_2022-03-09.tsv")
...
for(ami in 1:length(allMD)){
    ...
    figurePath <- file.path("/rsrch3/scratch/genomic_med/ychu2/projects/p1review/R3Q7/result/GSE179994/MappingResult", tempName)
