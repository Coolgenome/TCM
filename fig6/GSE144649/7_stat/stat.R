...
CD4PredictedObj <- readRDS("/rsrch3/scratch/genomic_med/ychu2/projects/p1review/R3Q7/result/GSE144649/6_mapping/CD4/querySeuratObj_2022-05-09.rds")
...
CD8PredictedObj <- readRDS("/rsrch3/scratch/genomic_med/ychu2/projects/p1review/R3Q7/result/GSE144649/6_mapping/CD8/querySeuratObj_2022-05-09.rds")
...
for(tCS in targetCellSet){
    for(tT in targetTreatments){
        for(ami in 1:length(allMD)){
            ...
            figurePath <- file.path("/rsrch3/scratch/genomic_med/ychu2/projects/p1review/R3Q7/result/GSE144649/7_MappingResult",
                                    tempName)
