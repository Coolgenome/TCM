...
CD8QueryPath <- "/rsrch3/scratch/genomic_med/ychu2/projects/p1review/R3Q7/result/GSE169246/TCells/forMapping/CD8.rds"
CD4QueryPath <- "/rsrch3/scratch/genomic_med/ychu2/projects/p1review/R3Q7/result/GSE169246/TCells/forMapping/CD4.rds"

CD8PredictedTPath <- "/rsrch3/scratch/genomic_med/ychu2/projects/p1review/R3Q7/result/GSE169246/MappingResult_MultiMap/CD8/predictedT_2022-04-29.rds"
CD4PredictedTPath <- "/rsrch3/scratch/genomic_med/ychu2/projects/p1review/R3Q7/result/GSE169246/MappingResult_MultiMap/CD4/predictedT_2022-04-29.rds"
...
CD4_meta$isResponse[CD4_meta$Patient %in% ResponsePatients] <- "Yes"
    ...
    for(tT in targetTreatments){
        for(ami in 1:length(allMD)){
            ...
            for(tempCluster in unique(tempMD$predicted.celltype)){
                ...
                TNR$isResponse <- "No"
                TNR$isResponse[TNR$Patient %in% ResponsePatients] <- "Yes"
                ...
                if(length(missedSamples) >0){
                    ...
                    isResponse[Patient %in% ResponsePatients] = "Yes"
                    tempTNR <- tibble(
                        Patient = Patient,
            ...
            figurePath <- file.path("/rsrch3/scratch/genomic_med/ychu2/projects/p1review/R3Q7/result/GSE169246/MappingResult_MultiMap", tempName)
            if(!dir.exists(figurePath)){
                dir.create(figurePath, recursive = T)
            }
            ggsave(file.path(figurePath, paste0(tempName, "_CellSet-", tCS, "_Treatment-", tT,"_response_bar.pdf")), g, width = 200, height = 1200, units = "mm")
